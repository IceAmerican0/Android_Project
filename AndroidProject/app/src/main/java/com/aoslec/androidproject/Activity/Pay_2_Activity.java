...
public class Pay_2_Activity extends AppCompatActivity {
    // Request 작업을 할 Queue
    ...
    public Pay_2_Activity() {

    }

    // 상품 이름과 가격을 초기화할 생성자
    public Pay_2_Activity(String productName, String productPrice) {
        Pay_2_Activity.productName = productName;
        Pay_2_Activity.productPrice = productPrice;
    }
