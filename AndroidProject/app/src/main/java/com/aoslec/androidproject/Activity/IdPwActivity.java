            ...
            try {
                ...
                if (ShareVar.login_fail != 0) {
                    ...
                    if (findpwcheck == 0) {
                        ...
                        MailTread mailTread = new MailTread(checkedEmail);
                        mailTread.start();
                        //이메일 전송하면 무조건 꺼짐
                        if (ShareVar.login_fail == 0) {
...
//    protected void onNewIntent(Intent intent) {
//        super.onNewIntent(intent);
//        String code = intent.getStringExtra("test2");
//        findpw_phone_pin.setText(code);
//
//    }
    ...
    class MailTread extends Thread{
        ...
        public MailTread(String checkedEmail) {
        ...
        public void run(){
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), "이메일 형식을 확인해주십시오", Toast.LENGTH_SHORT).show();
